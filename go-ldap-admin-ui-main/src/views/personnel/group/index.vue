    ...
    <el-card class="container-card" shadow="always">
      ...
      <el-dialog :title="dialogFormTitle" :visible.sync="updateLoading">
        <el-form ref="dialogForm" size="small" :model="dialogFormData" :rules="dialogFormRules" label-width="120px">
          ...
          <el-form-item v-if="dialogFormData.groupType === 'cn'" label="cn对象类型" prop="groupClass">
            <div style="display:flex;align-items:center;">
              <el-select v-model.trim="dialogFormData.groupClass" placeholder="选择LDAP分组类型" style="flex:1;">
                <el-option label="groupOfUniqueNames" value="groupOfUniqueNames" />
                <el-option label="posixGroup" value="posixGroup" />
              </el-select>
              <el-tooltip content="如需为LDAP用户提供SSH/系统登录，请选择posixGroup" placement="top">
      ...
      <el-dialog :title="dialogFormTitle" :visible.sync="dialogFormVisible">
        <el-form ref="dialogForm" size="small" :model="dialogFormData" :rules="dialogFormRules" label-width="120px">
          ...
          <el-form-item v-if="dialogFormData.groupClass === 'posixGroup'" label="Home目录">
  ...
  methods: {
    ...
    normalizer(node) {
      return {
        ...
        // 禁止选择posixGroup作为父节点；允许ou/cn作为父节点
